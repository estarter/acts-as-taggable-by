module ActsAsTaggableBy::Taggable
  module Cache
    def self.included(base)
      ...
      base.send :include, ActsAsTaggableBy::Taggable::Cache::InstanceMethods
      base.extend ActsAsTaggableBy::Taggable::Cache::ClassMethods
      
      base.class_eval do
        before_save :save_cached_tag_list        
      end
      
      base.intialize_acts_as_taggable_by_cache
    end
    
    module ClassMethods
      def intialize_acts_as_taggable_by_cache      
      ...
      def acts_as_taggable_by(*args)
        super(*args)
        intialize_acts_as_taggable_by_cache
      end
