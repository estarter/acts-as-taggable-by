...
describe "Taggable" do
  ...
  it "should be able to create tags" do
    ...
    @taggable.instance_variable_get("@skill_list").instance_of?(ActsAsTaggableBy::TagList).should be_true
    
    lambda {
      @taggable.save
    }.should change(ActsAsTaggableBy::Tag, :count).by(3)
  ...
  it "should not care about case" do
    ...
    ActsAsTaggableBy::Tag.find(:all).size.should == 1
...
puts ActsAsTaggableBy::Tag.all.inspect
puts ActsAsTaggableBy::Tagging.all.inspect
puts TaggableModel.tagged_with("ruby").inspect
